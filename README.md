...
*(A screenshot showcasing the clean, interactive listing exploration UI)*
> `![Listings Overview](assets/listings-screenshot.png)`

### AI Trip Planner in Action
*(A screenshot of a personalized day-by-day travel itinerary generated by Gemini AI)*
> `![AI Trip Planner](assets/planner-screenshot.png)`

### Secure Checkout Experience
*(A screenshot demonstrating the Razorpay payment modal integration)*
